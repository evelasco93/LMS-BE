...
iamStack.clientsLambdaRole.addToPolicy(new PolicyStatement({
  effect: Effect.ALLOW,
  actions: [
    'dynamodb:GetItem',
    'dynamodb:PutItem',
...
iamStack.affiliatesLambdaRole.addToPolicy(new PolicyStatement({
  effect: Effect.ALLOW,
  actions: [
    'dynamodb:GetItem',
    'dynamodb:PutItem',
...
// 3. Services Stack
const servicesStack = new ServicesStack(app, `${baseConfig.appPrefix}-ServicesStack`, {
  env,
  config: baseConfig,
  servicesConfig,
