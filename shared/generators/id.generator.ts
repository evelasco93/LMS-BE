...
export class IdGenerator {
   ...
   */
  static generate(prefix?: EntityPrefix | string, length: number = IdGenerator.DEFAULT_LENGTH): string {
   ...
   */
  static generateAffiliateId(length: number = IdGenerator.DEFAULT_LENGTH): string {
   ...
   */
  static generateCampaignId(length: number = IdGenerator.DEFAULT_LENGTH): string {
