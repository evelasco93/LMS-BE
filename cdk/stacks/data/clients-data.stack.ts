...
export interface IClientsDataStackProps extends NestedStackProps {
...
/**
 * Nested stack for clients data resources (DynamoDB table, future storage)
 */
export class ClientsDataStack extends NestedStack {
  public readonly table: Table;

  constructor(scope: Construct, id: string, props: IClientsDataStackProps) {
    super(scope, id, props);

    const { tableConfig, removalPolicy, logicalIdPrefix } = props;
    this.table = new Table(this, `${logicalIdPrefix}-ClientsTable`, {
