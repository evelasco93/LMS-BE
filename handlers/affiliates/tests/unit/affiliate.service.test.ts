...
import { mockAffiliate, mockExistingAffiliate } from '../fixtures/affiliate.fixtures';
...
describe('AffiliateService', () => {
  ...
  describe('getAffiliateByEmail', () => {
    it('should retrieve an affiliate by email', async () => {
      ...
      const result = await affiliateService.getAffiliateByEmail('test@affiliate.com');
    ...
    it('should return error if affiliate email not found', async () => {
      ...
      const result = await affiliateService.getAffiliateByEmail('nonexistent@affiliate.com');
