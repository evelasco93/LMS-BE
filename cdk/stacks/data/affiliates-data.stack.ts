...
export interface IAffiliatesDataStackProps extends NestedStackProps {
...
/**
 * Nested stack for affiliates data resources (DynamoDB table, future storage)
 */
export class AffiliatesDataStack extends NestedStack {
  public readonly table: Table;

  constructor(scope: Construct, id: string, props: IAffiliatesDataStackProps) {
    super(scope, id, props);

    const { tableConfig, removalPolicy, logicalIdPrefix } = props;

    this.table = new Table(this, `${logicalIdPrefix}-AffiliatesTable`, {
